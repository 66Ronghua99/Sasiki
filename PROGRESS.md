...
## TODO
- `P0` 执行 `docs/superpowers/plans/2026-03-22-refine-tool-surface-unification-implementation.md` Task 5：开始迁移 core browser tools（`observe.page` 到 `act.select_tab`）为 first-class definitions，并维持当前 tool order / behavior parity。
