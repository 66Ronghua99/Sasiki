...
class WorkflowStorage:
    ...
    def __init__(self, base_dir: Optional[Path] = None):
        self.base_dir = base_dir or get_settings().workflows_dir
    ...
    def load(self, workflow_id: UUID) -> Optional[Workflow]:
        ...
        try:
            ...
            get_logger().error("failed_to_load_workflow", workflow_id=str(workflow_id), error=str(e))
            return None
    ...
    def delete(self, workflow_id: UUID) -> bool:
        ...
        get_logger().info("workflow_deleted", workflow_id=str(workflow_id))
        return True
