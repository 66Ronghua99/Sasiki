...
class SessionManager:
    ...
    @staticmethod
    async def inject_cookies_from_file(context: BrowserContext, cookie_file_path: str | Path):
        """
    ...
    @staticmethod
    async def export_cookies_to_file(context: BrowserContext, cookie_file_path: str | Path):
