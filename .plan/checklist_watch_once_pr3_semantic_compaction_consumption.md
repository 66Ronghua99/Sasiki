...
- [x] Phase-2: 可选 LLM 语义增强接入（off|auto|on）
- [x] Phase-2: 语义增强失败回退 rule-based 输出
- [x] Phase-3: run 路径接入 SOP 资产检索与上下文注入
- [x] Phase-3: 资产消费日志可追踪（asset_id/guide_source/fallback）
- [x] typecheck 通过
- [x] build 通过
