...
- <changed> generic [ref=e1]:
  - ref=e2 [unchanged]
  - paragraph [ref=e3]: Modal open
  - button "Open modal" [active] [ref=e4]
  - dialog "Filters" [ref=e6]:
    - strong [ref=e7]: Filters
    - paragraph [ref=e8]: Apply filters before continuing.
    - button "Close" [ref=e9]
```
