/**
 * Deps: runtime/observe-support/sop-trace-builder.ts, runtime/observe-support/sop-trace-guide-builder.ts
 * Used By: runtime/observe-executor.ts, runtime/runtime-composition-root.ts
