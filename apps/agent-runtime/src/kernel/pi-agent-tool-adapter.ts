...
export interface PiAgentToolCallHookCapture {
...
export interface PiAgentToolCallHookObserver {
  beforeToolCall(context: ToolCallHookContext): Promise<PiAgentToolCallHookCapture | null>;
  afterToolCall(
    context: ToolCallHookContext,
    rawResult: ToolCallResult,
    beforeCapture: PiAgentToolCallHookCapture | null,
  ): Promise<PiAgentToolCallHookCapture | null>;
}

export interface PiAgentToolAdapterOptions {
  hookObserver?: PiAgentToolCallHookObserver | null;
  hookContext?: Partial<ToolCallHookContext>;
}

export class PiAgentToolAdapter {
  private readonly client: ToolClient;
  private hookObserver: PiAgentToolCallHookObserver | null;
  ...
  setHookObserver(observer: PiAgentToolCallHookObserver | null): void {
  ...
  private async captureBefore(context: ToolCallHookContext): Promise<PiAgentToolCallHookCapture | null> {
  ...
  private getObservationTextOverride(capture: PiAgentToolCallHookCapture | null): string | undefined {
    if (!capture) {
      return undefined;
    }
